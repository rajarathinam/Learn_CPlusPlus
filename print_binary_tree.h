...
struct BTree 
{
  BTree *left, *right;
  int data;
  BTree(int val) : left(NULL), right(NULL), data(val)
  {
  }
};
...
void printBranches(int branchLen, int nodeSpaceLen, int startLen, int nodesInThisLevel, const deque<BTree*>& nodesQueue, ostream& out) {
...
void printNodes(int branchLen, int nodeSpaceLen, int startLen, int nodesInThisLevel, const deque<BTree*>& nodesQueue, ostream& out) {
  deque<BTree*>::const_iterator iter = nodesQueue.begin();
...
void printLeaves(int indentSpace, int level, int nodesInThisLevel, const deque<BTree*>& nodesQueue, ostream& out) {
  deque<BTree*>::const_iterator iter = nodesQueue.begin();
  for (int i = 0; i < nodesInThisLevel; i++, iter++) {
